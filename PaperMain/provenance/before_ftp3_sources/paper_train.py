...
def plan(args, root=ROOT):
    ...
    if args.resume:
        ...
        if saved_profile is not None:
            ...
            validate_profile_record(saved_profile, root)
        ...
        if args.calibration_profile is not None:
            ...
            supplied_profile = load_profile_record(supplied_path, root)
        ...
        manifest = {
            ...
            'calibration_application': ('Base-calibrated beta transferred to NARROW training world'
