#!/bin/bash
# QueuePostRZF_S40HighLoad -- S40-generation HIGH-LOAD arm (user directive 2026-07-20).
...
RUN_DIR=Run4/QueuePostRZF_S40HighLoad
LOG=Run4/QueuePostRZF_S40HighLoad_run.log
...
for i in $(seq 1 1000); do
  ...
  if [ -f "$RUN_DIR/ckpt/latest.pt" ]; then
    ...
    ARGS="--run_root Run4 --run_name QueuePostRZF_S40HighLoad"
  fi
