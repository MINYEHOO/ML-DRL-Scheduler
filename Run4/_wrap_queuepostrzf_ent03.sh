#!/bin/bash
# QueuePostRZF_Ent03 -- entropy 0.03 fork of the pilot (user, 2026-07-16):
# forked from the 0.01 arm at its CURRENT ckpt (~upd 289, i.e. 100 upd after
# the Ent02 fork point 189 -- three-way comparison is NOT update-aligned).
...
RUN_DIR=Run4/QueuePostRZF_Ent03
LOG=Run4/QueuePostRZF_Ent03_run.log
...
for i in $(seq 1 1000); do
  ...
  python3 train_phase2.py --mode queue \
    ...
    --entropy_coef 0.03 --patience_evals 100000 --seed 2024 $ARGS >> "$LOG" 2>&1
