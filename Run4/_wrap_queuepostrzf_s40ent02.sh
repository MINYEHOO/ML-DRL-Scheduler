#!/bin/bash
# QueuePostRZF_S40Ent02 -- S40-generation main run (user directive 2026-07-20).
...
RUN_DIR=Run4/QueuePostRZF_S40Ent02
LOG=Run4/QueuePostRZF_S40Ent02_run.log
...
for i in $(seq 1 1000); do
  ...
  if [ -f "$RUN_DIR/ckpt/latest.pt" ]; then
    ...
    ARGS="--run_root Run4 --run_name QueuePostRZF_S40Ent02"
  fi
