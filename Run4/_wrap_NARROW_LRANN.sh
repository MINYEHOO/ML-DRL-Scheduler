...
for i in $(seq 1 1000); do
  ...
  else ARGS="--run_root Run4 --run_name QueuePostRZF_S40HL_CQI4_NARROW_LRANN"; fi
  ...
  python3 train_phase2.py --mode queue --la_mode post_rzf --decode_order rbg_major \
    ...
    --lr_final 0.0 --lr_decay_updates 866 --p_arrival_min 0.30 --p_arrival_max 0.30 --ue_speed_min 20 --ue_speed_max 20 --n_active_min 24 --n_active_max 24 $ARGS >> "$LOG" 2>&1
