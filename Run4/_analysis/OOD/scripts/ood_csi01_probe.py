"""CSI01 probe: p_csi = 0.1 zero-shot (user-requested 2026-08-05).
...
OUT = "Run4/_analysis/ood_csi01.csv"
SEEDS = list(range(30000, 30008))
SUS_THRS = [0.60, 0.65, 0.70, 0.75, 0.80]

EDITIONS = [
    ("CSI01-cont", "Run4/QueuePostRZF_S40HighLoad"),
    ("CSI01-cqi4", "Run4/QueuePostRZF_S40HL_CQI4"),
]
...
print("\n=== CSI01 (p_csi 0.1) zero-shot 요약, seeds 30000-30007 ===")
