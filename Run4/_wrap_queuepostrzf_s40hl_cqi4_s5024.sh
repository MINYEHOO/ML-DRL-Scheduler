#!/bin/bash
# QueuePostRZF_S40HL_CQI4_s5024 -- TRAINING-SEED REPLICATE of the paper's main
...
RUN_DIR=/home/MYH/ML_DRL_Scheduler/Run4/QueuePostRZF_S40HL_CQI4_s5024
LOG=/home/MYH/ML_DRL_Scheduler/Run4/QueuePostRZF_S40HL_CQI4_s5024_run.log
...
for i in $(seq 1 1000); do
  ...
  if [ -f "$RUN_DIR/ckpt/latest.pt" ]; then
    ...
    ARGS="--run_root /home/MYH/ML_DRL_Scheduler/Run4 --run_name QueuePostRZF_S40HL_CQI4_s5024"
  fi
  ...
  python3 train_phase2.py --mode queue \
    ...
    --num_updates 866 \
    --patience_evals 100000 --seed 5024 $ARGS >> "$LOG" 2>&1
