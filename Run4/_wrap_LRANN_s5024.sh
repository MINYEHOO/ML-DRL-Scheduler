...
RUN_DIR=Run4/QueuePostRZF_S40HL_CQI4_LRANN_s5024
LOG=Run4/QueuePostRZF_S40HL_CQI4_LRANN_s5024_run.log
for i in $(seq 1 1000); do
  if [ -f "$RUN_DIR/ckpt/latest.pt" ]; then ARGS="--resume $RUN_DIR/ckpt/latest.pt"
  else ARGS="--run_root Run4 --run_name QueuePostRZF_S40HL_CQI4_LRANN_s5024"; fi
  ...
  python3 train_phase2.py --mode queue --la_mode post_rzf --decode_order rbg_major \
    ...
    --entropy_coef 0.02 --ppo_save_every 1 --patience_evals 100000 --seed 5024 \
