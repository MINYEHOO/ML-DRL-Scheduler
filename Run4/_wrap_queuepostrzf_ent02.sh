#!/bin/bash
# QueuePostRZF_Ent02 -- entropy 0.02 A/B fork of the pilot (user, 2026-07-15):
# forked from QueuePostRZF ckpt (see RUN_MANIFEST), original stays 0.01 on GPU5.
...
RUN_DIR=Run4/QueuePostRZF_Ent02
LOG=Run4/QueuePostRZF_Ent02_run.log
