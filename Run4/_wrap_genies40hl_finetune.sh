#!/bin/bash
# GenieS40HL_FineTune -- genie-CSI HighLoad world (warm-start from HighLoad best@639), 2026-07-27.
...
RUN_DIR=Run4/GenieS40HL_FineTune
LOG=Run4/GenieS40HL_FineTune_run.log
...
for i in $(seq 1 1000); do
  ...
  if [ -f "$RUN_DIR/ckpt/latest.pt" ]; then
    ...
    ARGS="--run_root Run4 --run_name GenieS40HL_FineTune --init_from Run4/QueuePostRZF_S40HighLoad/ckpt/best.pt"
  fi
